...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = KEYMAP(
        ...
        _____,   _____,   _____,   _____,   _____,   _____,   _____,   KC_PGUP, KC_UP,   KC_PGDN, KC_PSCR, LALT(KC_SLSH), LALT(KC_EQL), _____,            \
        _____,   _____,   _____,   _____,   _____,   _____,   KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  LALT(KC_MINS), _____,                          \
        _____,   _____,   _____,   _____,   _____,   _____,   _____,   KC_MUTE, KC_VOLD, KC_VOLU, KC_END,  LCA(KC_Z),     _____,        _____,            \
